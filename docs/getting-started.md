...
- `apps/web/src/teleforge-generated/client-flow-manifest.ts`: browser-safe flow metadata generated by `teleforge generate client-manifest` for Mini App screen resolution
